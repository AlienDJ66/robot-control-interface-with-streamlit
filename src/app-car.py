...
# UI Inputs
# ------------------------------
target_x = st.number_input("Target X", value=0.5, min_value=-10.0, max_value=10.0, step=0.01)
target_y = st.number_input("Target Y", value=0.0, min_value=-10.0, max_value=10.0, step=0.01)
